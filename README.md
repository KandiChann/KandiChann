...
‎‎
 ...
 <details>
  <summary> ${\textsf{\color{#3e393c}     𖹭𖹭 }}$ ${\textsf{\color{#dab872}  Currrent fixations/fandoms }}$ </summary><br>
  REGECT, MCYT, UNSTABLE UNIVERSE, STRENGTH SMP
  <br>
 </details>


 <details>
  <summary> ${\textsf{\color{#3e393c}     𖹭𖹭 }}$ ${\textsf{\color{#fff8f4}  REGECT GIFS!! }}$ </summary><br>
  <br>
